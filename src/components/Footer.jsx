...
const Footer = () => {
	...
	return (
		<footer className='grid sm:grid-cols-2 gap-1 sm:py-[5%] py-[5%] sm:mb-0 mb-[8%] bg-white sm:rounded-t-full justify-center'>
			...
			<div className='flex justify-center items-center sm:ml-[20%] '>
				...
				<span className='text-xs text-slate-400	'>This website made by my sis
